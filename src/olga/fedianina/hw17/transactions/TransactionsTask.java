package olga.fedianina.hw17.transactions;
...
public class TransactionsTask {
    public static void main(String[] args) {
        ...
        Map<String,Long> map = transactionStream.collect(Collectors.toMap(elem ->elem.getAccount().getNumber(),elem ->elem.getSum(), (elemValue1, elemValue2) -> elemValue1+elemValue2));
        System.out.println(map);
        Stream<Transaction> transactionStream1 = Stream.of(transaction1, transaction2, transaction3,
                transaction4, transaction5, transaction6, transaction7);
        System.out.println(transactionStream1.flatMapToLong(elem -> LongStream.of(elem.getSum())).sum());
